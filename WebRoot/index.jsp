...
<%
	Object object=request.getAttribute("page1");
	if (object == null) {
		response.sendRedirect("selectAllBlogs_article");
		return;
	} 
%>
<%
	...
	#fenye{
	  ...
	  <div class="body_first">
		  <div class="col-md-12 column" >
				<blockquote>
					...
					</span> <cite>${item.getWrite_time()}</cite>
					<cite>${item.getContent()}</cite></small>
				</blockquote>
			</div>
	  </div>
	 </c:forEach>
	 <div class="col-md-12 column" id="fenye">	
			<ul class="pagination pagination-lg">
				<li>
					 <a href="selectAllBlogs_article?pageNo=${page1.pageNo-1}">上一页</a>
				</li>
				<c:forEach var= "temp"   begin= "1"   step= "1" end="${page1.totalPageCount}">
					<li>
						 <a href="selectAllBlogs_article?pageNo=${temp-1}">${temp}</a>
					</li>
	 			</c:forEach>
	 			<li>
					 <a href="selectAllBlogs_article?pageNo=${page1.pageNo+1}">下一页</a>
				</li>
			</ul>
	</div>
