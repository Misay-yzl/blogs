...
@WebServlet("/SelectAuthor_blogs")
public class Servlet_SelectAuthor_blogs extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		req.getRequestDispatcher("select_author_blogs.jsp").forward(req, resp);
	}
